...
<body>
<nav>
  <li><a class="job" href="#t0">EXIT</a></li> 
  <li><a class="#" href="#t1">CCTV</a></li>
  <li><a class="#" href="#t2">FLOW</a></li>
  <li><a class="#" href="#t3">GUI</a></li>
  <li><a class="#" href="#t4">회로도</a></li>
  <li><a class="#" href="#t5">ROBOT</a></li>
